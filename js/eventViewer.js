...
function update_scales(sizes){
    ...
    var x = d3.time.scale()
        .domain([new Date("2017-08-22 06:00:00"), new Date("2017-09-08 06:00:00")])
...
function create_timeseries_plot(series1, series2, sizes){
    ...
    brush = d3.svg.brush()
        .x(x)
        .extent([new Date("2017-08-22 06:00:00"), new Date("2017-08-22 18:00:00")])
        .on("brush", function() {
            brushed(series1);
        });
...
function animate() {
    ...
    var dataSetEndTime = new Date("2017-08-22 18:00:00"); //TODO: this needs to be 'dynamic'.
